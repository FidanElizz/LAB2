...
def MCC_matrix(input_file):
    ...
    with open(input_file,"r")as ids:
        ...
        for file_name in input_file:
            ...
            with open("/Users/fidanqurbanova/Downloads/LAB2_project/dssp_trainingC/"+dssp_id+'.dssp',"r")as test,open("/Users/fidanqurbanova/Downloads/LAB2_project/CV5/Predicted/"+file_name ,"r")as predict:
