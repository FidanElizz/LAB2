...
def Train(WindowSize, input_file, output):
    ...
    with open(input_file,"r")as ids:
        ...
        for file_name in input_file:
            ...
            numfiles +=1
            pdbID = file_name[:-3]
            m = np.loadtxt("/Users/fidanqurbanova/Downloads/LAB2_project/seqprofile_training/"+ pdbID+ "txt")
    
            seqprof = open("/Users/fidanqurbanova/Downloads/LAB2_project/seqprofile_training/"+pdbID+"txt", "r")
            proflines=seqprof.readlines()
    
            f = open("/Users/fidanqurbanova/Downloads/LAB2_project/dssp_training/"+pdbID+"dssp", "r")
            lines = f.readlines()[1:]
            for line in lines:
                line = line.rstrip()
                SS = line
