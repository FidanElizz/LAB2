...
def makeSVMfile(ids_file,ws,outfolder):
	with open(ids_file,"r")as ids:
		...
		for id in ids_file:
			filename=id.rstrip()
			seqid=filename[:-4]
			with open("/Users/fidanqurbanova/Downloads/LAB2_project/seqprofile_BTS/"+seqid+"..txt","r")as seqprof,open("/Users/fidanqurbanova/Downloads/LAB2_project/dssp.formated/"+seqid+".txt","r")as ss:
